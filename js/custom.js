				...
				<div class="modal-content">
					...
					<div>
						<div class="modal-header">
							<span class="title-head">Apply Now</span>
							<h3 class="modal-title" id="exampleModalLongTitle">Admissions Open</h3>
							<p class="text">(B.Sc, B.Com, BCA)</p>
						</div>
						<div class="modal-body">
							<form action="script/mailchamp.php" class="dzSubscribe" method="post">
								...
								<div class="form-group">
									...
									<select  name="dzEmail" class="form-control">
									<option>B.Sc</option>
									<option>B.Com</option>
									</select>

								</div>
								<button name="submit" type="submit" value="Submit" class="btn btn-secondary btn-block m-b15 text-uppercase">Submit</button>
